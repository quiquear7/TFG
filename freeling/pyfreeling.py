...
LSTM = _pyfreeling.LSTM
NO_SRL = _pyfreeling.NO_SRL
SRL_TREELER = _pyfreeling.SRL_TREELER
...
CFG_OK = _pyfreeling.CFG_OK
CFG_WARNING = _pyfreeling.CFG_WARNING
CFG_ERROR = _pyfreeling.CFG_ERROR
class config_options(object):
    ...
    DEP_LSTMFile = property(_pyfreeling.config_options_DEP_LSTMFile_get, _pyfreeling.config_options_DEP_LSTMFile_set)
    SRL_TreelerFile = property(_pyfreeling.config_options_SRL_TreelerFile_get, _pyfreeling.config_options_SRL_TreelerFile_set)
...
class invoke_options(object):
    ...
    SRL_which = property(_pyfreeling.invoke_options_SRL_which_get, _pyfreeling.invoke_options_SRL_which_set)
...
class status(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    stat = property(_pyfreeling.status_stat_get, _pyfreeling.status_stat_set)
    description = property(_pyfreeling.status_description_get, _pyfreeling.status_description_set)

    def __init__(self):
        _pyfreeling.status_swiginit(self, _pyfreeling.new_status())
    __swig_destroy__ = _pyfreeling.delete_status

# Register status in _pyfreeling:
_pyfreeling.status_swigregister(status)

class analyzer_config(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    config_opt = property(_pyfreeling.analyzer_config_config_opt_get, _pyfreeling.analyzer_config_config_opt_set)
    invoke_opt = property(_pyfreeling.analyzer_config_invoke_opt_get, _pyfreeling.analyzer_config_invoke_opt_set)

    def __init__(self):
        _pyfreeling.analyzer_config_swiginit(self, _pyfreeling.new_analyzer_config())
    __swig_destroy__ = _pyfreeling.delete_analyzer_config

    def parse_options(self, *args) -> "void":
        return _pyfreeling.analyzer_config_parse_options(self, *args)

    def check_invoke_options(self, opt: "freeling::analyzer_config::invoke_options const &") -> "freeling::status":
        return _pyfreeling.analyzer_config_check_invoke_options(self, opt)

# Register analyzer_config in _pyfreeling:
_pyfreeling.analyzer_config_swigregister(analyzer_config)
...
class analyzer(object):
    ...
    def set_current_invoke_options(self, opt: "invoke_options") -> "void":
        return _pyfreeling.analyzer_set_current_invoke_options(self, opt)

    def get_current_invoke_options(self) -> "freeling::invoke_options const &":
...
class crf_nerc(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, arg2: "std::wstring const &"):
        _pyfreeling.crf_nerc_swiginit(self, _pyfreeling.new_crf_nerc(arg2))
    __swig_destroy__ = _pyfreeling.delete_crf_nerc

    def analyze(self, *args) -> "freeling::document":
        return _pyfreeling.crf_nerc_analyze(self, *args)

# Register crf_nerc in _pyfreeling:
_pyfreeling.crf_nerc_swigregister(crf_nerc)
...
class dep_lstm(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, fname: "std::wstring const &"):
        _pyfreeling.dep_lstm_swiginit(self, _pyfreeling.new_dep_lstm(fname))
    __swig_destroy__ = _pyfreeling.delete_dep_lstm

    def analyze(self, *args) -> "freeling::document":
        return _pyfreeling.dep_lstm_analyze(self, *args)

# Register dep_lstm in _pyfreeling:
_pyfreeling.dep_lstm_swigregister(dep_lstm)

class srl_treeler(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, arg2: "std::wstring const &"):
        _pyfreeling.srl_treeler_swiginit(self, _pyfreeling.new_srl_treeler(arg2))
    __swig_destroy__ = _pyfreeling.delete_srl_treeler

    def analyze(self, *args) -> "freeling::document":
        return _pyfreeling.srl_treeler_analyze(self, *args)

# Register srl_treeler in _pyfreeling:
_pyfreeling.srl_treeler_swigregister(srl_treeler)
